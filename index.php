...
<html lang="en">
  ...
  <?php
 try {
  $conn = new PDO("sqlsrv:server = tcp:capstoneserve.database.windows.net,1433; Database = Capstone", "rootdb", "{Baji@123}");
...
$connectionInfo = array("UID" => "rootdb", "pwd" => "{Baji@123}", "Database" => "Capstone", "LoginTimeout" => 30, "Encrypt" => 1, "TrustServerCertificate" => 0);
$serverName = "tcp:capstoneserve.database.windows.net,1433";
